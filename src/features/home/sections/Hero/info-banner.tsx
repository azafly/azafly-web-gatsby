    ...
    return (
        <motion.div className={classes.container}>
            ...
            <div className={classes.actionDiv}>
                <Link to={`${process.env.GATSBY_APP_URL}/booking`} className={classes.link}>
                    <Button variant='contained' className={classes.actionButtonBook} endIcon={<CalendarSvgComponent />}>
                        {frontMatter.consultButtonText}
                    </Button>
                </Link>
                <Link to={`${process.env.GATSBY_APP_URL}/payment`} className={classes.link}>
                    <Button className={classes.actionButtonExplore}>{frontMatter.paymentButtonText}</Button>
                </Link>
            </div>
        </motion.div>
    );
