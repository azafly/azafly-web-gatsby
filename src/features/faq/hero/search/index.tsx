    ...
    return (
        <div className={classes.searchRoot}>
            <div className="s">
                ...
                <Typography className="m-1 text-sm font-semibold text-center" color="textPrimary" > Popular Topics
            <br />
                    <span className="font-semibold text-center">
                        {topics.map(({ label, link }) => <Link to={link} className="p-2 text-sm text-center">#{label}</Link>)}
                    </span>
                </Typography>
            </div>
        </div>
