...
export const pageQuery = graphql`
    {
        ...
        recentPosts: allMarkdownRemark(limit: 10, sort: { fields: [frontmatter___publishedDate], order: DESC }) {
            edges {
                node {
                    id
                    fields {
...
const Blog: FunctionComponent<Blog> = ({ data }) => {
    ...
    const featuredPostData: PostSnippet[] = data.featuredPosts.edges.map(mapPostData);
